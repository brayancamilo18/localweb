...
<style>
  ...
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  .bold-map-radar-ring{position:absolute;left:50%;top:50%;width:54px;height:54px;margin:-20px 0 0 -20px;border:2px solid var(--accent);box-shadow:0 0 10px rgba(26,79,63,.25);animation:boldMapRadar 2.5s cubic-bezier(.2,.7,.2,1) infinite;pointer-events:none}
