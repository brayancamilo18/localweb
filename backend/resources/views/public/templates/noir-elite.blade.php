...
<style>
  ...
  *{ box-sizing:border-box; margin:0; padding:0; }
  ...
  nav.top .logo.brand-has-img .nav-brand-img{
    display:block;
    height:calc(38px * var(--lw-logo-scale, 1));
    width:auto;
    max-width:calc(160px * var(--lw-logo-scale, 1));
    object-fit:contain;
  ...
  .hero-tagline{
    ...
    max-width:540px; margin:18px auto 0; line-height:1.7;
  }
  ...
  /* Footer */
  footer{
    background:var(--bg-3); padding:80px 0 32px; margin-top:0;
  }
  .foot-grid{
  ...
  .social a{
    width:36px; height:36px; border:1px solid var(--gold-line); border-radius:999px;
  ...
  .foot-map-sub{
    text-align:center; color:var(--muted); font-size:14px; max-width:640px; margin:0 auto 22px;
    line-height:1.55;
  }
  .foot-map-shell{
    position:relative;
  ...
  .foot-map-placeholder{
    text-align:center; color:var(--muted); font-size:13px; padding:36px 20px;
    border:1px dashed var(--gold-line); border-radius:12px; max-width:640px; margin:0 auto;
    line-height:1.6;
  }
  ...
  .noir-reviews-sub{
    text-align:center; color:var(--muted); font-size:15px; line-height:1.75; max-width:640px; margin:16px auto 0;
    font-weight:300;
  }
  ...
  <div class="wrap" id="aboutSec">
    <div class="about-grid">
      <div class="about-text">
        ...
        <div class="reveal-up delay-4" style="margin-top:32px; display:flex; gap:14px; flex-wrap:wrap;">
