    ...
    'disks' => [
        ...
        */
        'r2' => filled(env('AWS_ACCESS_KEY_ID', env('CLOUDFLARE_R2_KEY'))) ? [
            ...
            'url' => rtrim(env('APP_URL', 'http://localhost'), '/').'/storage/r2-local',
            'visibility' => 'public',
            'throw' => false,
            'report' => false,
        ],
        ...
        /*
        | Misma ruta que el fallback de `r2` sin AWS. Sirve para copiar a MinIO archivos
        | subidos antes de configurar S3 (artisan business-images:sync-to-object-storage).
        */
        'r2_legacy_local' => [
            'driver' => 'local',
            'root' => storage_path('app/public/r2-local'),
