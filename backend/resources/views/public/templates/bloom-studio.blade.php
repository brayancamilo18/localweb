...
<style>
  ...
  *{ box-sizing:border-box; margin:0; padding:0; }
  ...
  .wrap{ max-width:1254px; margin:0 auto; padding:0 46px; }

  /* ─── REVEAL (alterna izquierda/derecha) ────────────── */
  .r-left, .r-right, .r-up{
    opacity:0; transition:opacity .9s ease, transform .9s cubic-bezier(.2,.7,.2,1);
  }
  .r-left{ transform:translateX(-54px); }
  .r-right{ transform:translateX(54px); }
  ...
  nav.top .logo.brand-has-img .nav-brand-img{
    display:block;
    height:calc(54px * var(--lw-logo-scale, 1));
    width:auto;
  ...
  .sheet a{ font-family:var(--serif); font-size:46px; font-weight:600; }
  ...
  .shape.s2{ width:230px; height:230px; right:8%; top:24%; border-color:var(--peach); animation:float2 8s ease-in-out infinite -1s; opacity:.45; }
  .shape.s3{ width:380px; height:280px; right:14%; bottom:6%; border-color:var(--blush); border-radius:50%; transform:rotate(-12deg); animation:float1 9s ease-in-out infinite -2s; }
  ...
  .hero-inner{
    ...
    justify-content:center; gap:24px; padding:0 46px;
    color:#fff; max-width:1254px; margin:0 auto;
  }
  .hero-eyebrow{
  ...
  .hero-tagline{ font-size:17px; opacity:.92; max-width:554px; line-height:1.6; }
  .hero-actions{ display:flex; gap:12px; flex-wrap:wrap; }
  .hero-meta{
    position:absolute; left:46px; right:46px; bottom:46px;
    display:flex; justify-content:space-between; align-items:flex-end; gap:24px;
    color:rgba(255,255,255,.85); font-size:13px;
  }
  .hero-meta .item{ display:flex; flex-direction:column; gap:2px; }
  .hero-meta .num{ font-family:var(--serif); font-size:52px; line-height:1; color:#fff; }
  ...
  .about-text h2{
    font-family:var(--serif); font-weight:600;
    font-size:clamp(50px, 4.4vw, 56px); line-height:1.05; letter-spacing:-.02em;
    margin-bottom:22px;
  }
  ...
  .bloom-about-extras{display:flex;flex-direction:column;gap:clamp(56px,8vw,80px);margin-top:clamp(56px,8vw,80px);padding-top:clamp(40px,6vw,56px);border-top:1px solid rgba(28,28,28,.08)}
  .bloom-about-extra{display:grid;grid-template-columns:1fr 1.05fr;gap:clamp(40px,6vw,80px);align-items:center}
  .bloom-about-extra--text-first .bloom-about-extra__copy{order:1}
  .bloom-about-extra--text-first .bloom-about-extra__photo{order:2}
  .bloom-about-extra--photo-first .bloom-about-extra__photo{order:1}
  .bloom-about-extra--photo-first .bloom-about-extra__copy{order:2}
  .bloom-about-extra__title{font-family:var(--serif);font-weight:600;font-size:clamp(36px,3.6vw,48px);line-height:1.08;letter-spacing:-.02em;margin:0 0 18px}
  .bloom-about-extra__desc{font-size:16px;line-height:1.85;color:rgba(28,28,28,.78);margin:0;max-width:48ch}
  .bloom-about-extra__img{aspect-ratio:4/5;position:relative;border-radius:8px;overflow:hidden;background:var(--bg-2);clip-path:polygon(0 0,96% 0,100% 8%,100% 100%,4% 100%,0 92%)}
  .bloom-about-extra__img img{width:100%;height:100%;object-fit:cover;display:block}
  ...
  .pill-tel:hover{ transform:translateY(-2px); box-shadow:0 18px 54px color-mix(in srgb, var(--coral) 35%, transparent); }
  ...
  .gallery-head h2{
    font-family:var(--serif); font-weight:600;
    font-size:clamp(54px, 5vw, 64px); letter-spacing:-.02em; line-height:1;
    max-width:14ch;
  }
  .gallery-head h2 em{ color:var(--coral); font-style:italic; }
  .gallery-head .right{ max-width:354px; color:rgba(245,240,232,.7); font-size:15px; line-height:1.7; }
  .grid{
    display:grid;
  ...
  .sched-head h2{ font-family:var(--serif); font-weight:600; font-size:clamp(50px, 4.4vw, 56px); letter-spacing:-.02em; }
  ...
  @media (max-width:980px){
    ...
    .days .card{ min-width:230px; scroll-snap-align:start; }
  }
  .days .card{
  ...
  .foot{
    ...
    padding-bottom:54px; border-bottom:1px solid rgba(245,240,232,.12);
  }
  ...
  .bloom-map-sub{ text-align:center; color:rgba(245,240,232,.65); font-size:14px; max-width:654px; margin:0 auto 20px; line-height:1.55; }
  .bloom-map-shell{
    position:relative;
  ...
  .bloom-map-placeholder{ text-align:center; color:rgba(245,240,232,.5); font-size:13px; padding:46px 20px; border:1px dashed rgba(245,240,232,.2); border-radius:14px; max-width:654px; margin:0 auto; line-height:1.6; }
  ...
  .bloom-svc-card:hover{ transform:translateY(-3px); box-shadow:0 16px 50px color-mix(in srgb, var(--coral) 12%, transparent); }
  ...
  .bloom-reviews-sub{ max-width:654px; margin:16px auto 0; text-align:center; color:rgba(245,240,232,.72); font-size:16px; line-height:1.75; font-weight:400; }
  ...
  @media (max-width:980px){
    ...
    .bloom-about-extra{grid-template-columns:1fr;gap:40px}
    .bloom-about-extra__photo{order:-1!important}
  ...
  body.embed-preview #aboutExtraBlocks .bloom-about-extra.reveal .r-left,
  body.embed-preview #aboutExtraBlocks .bloom-about-extra.reveal .r-right,
  body.embed-preview #aboutExtraBlocks .bloom-about-extra.reveal .r-up{
    opacity:1 !important;
...
<section id="servicios" style="display:none;">
  <div class="wrap" id="servicesSec">
    <div class="sched-head" style="margin-bottom:50px;">
...
function escapeAttrBloom(s) {
  return String(s).replace(/&/g, '&amp;').replace(/"/g, '&quot;').replace(/</g, '&lt;');
}

function renderBloomAboutExtras(sections) {
  var wrap = document.getElementById('aboutExtraBlocks');
  if (!wrap) return;
  wrap.className = 'bloom-about-extras';
  ...
  wrap.innerHTML = list
    .map(function (sec, i) {
      var title = escapeHtmlTextBloom(String(sec.title || '').trim());
      var desc = escapeHtmlTextBloom(String(sec.description || '').trim());
      ...
      var mod = textFirst ? 'bloom-about-extra--text-first' : 'bloom-about-extra--photo-first';
      var blockNum = String(i + 3).padStart(2, '0');
      var imgTag = img
        ? '<img src="' + escapeAttrBloom(img) + '" alt="" loading="lazy" decoding="async"/>'
        : '';
      return (
        '<article class="bloom-about-extra ' +
        mod +
        '">' +
        '<div class="bloom-about-extra__copy r-right d-1">' +
        '<span class="eyebrow-coral bloom-about-extra__kicker">Bloque ' +
        blockNum +
        '</span>' +
        (title ? '<h3 class="bloom-about-extra__title">' + title + '</h3>' : '') +
        (desc ? '<p class="bloom-about-extra__desc">' + desc + '</p>' : '') +
        '</div>' +
        '<div class="bloom-about-extra__photo r-left">' +
        '<div class="bloom-about-extra__img' +
        (img ? ' has-photo' : '') +
        '">' +
        imgTag +
        '</div></div></article>'
    ...
    .join('');
  wrap.querySelectorAll('.bloom-about-extra').forEach(function (el) {
    el.classList.add('reveal');
  });
  if (typeof window.lwRefreshAboutExtrasReveal === 'function') {
    window.lwRefreshAboutExtrasReveal();
  }
  if (typeof window.bloomRevealAboutExtras === 'function') {
    window.bloomRevealAboutExtras();
  }
}

window.lwRenderAboutExtrasImpl = renderBloomAboutExtras;
...
(function initSectionRevealsBloom(){
  ...
  window.bloomRevealAboutExtras = function(){
    document.querySelectorAll('#aboutExtraBlocks .bloom-about-extra').forEach(function(el, i){
      if (io && io.observe) {
        try { io.observe(el); } catch (err) { /* ya observado */ }
      }
      var delay = embedPreview ? 20 + i * 70 : 40 + i * 100;
