...
<style>
  ...
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  .eyebrow::before{content:"";width:36px;height:1px;background:var(--champagne)}

  /* ─── NAV ─── */
  .nav{position:fixed;top:0;left:0;right:0;z-index:60;padding:0 40px;transition:padding .3s,background .3s,backdrop-filter .3s}
  ...
  .burger{display:none;width:38px;height:38px;background:transparent;border:none;cursor:pointer;flex-direction:column;align-items:center;justify-content:center;gap:5px;padding:0}
  .burger span{display:block;width:22px;height:1px;background:var(--ink);transition:.3s}
  .burger.open span:nth-child(1){transform:translateY(6px) rotate(45deg)}
  .burger.open span:nth-child(2){opacity:0}
  .burger.open span:nth-child(3){transform:translateY(-6px) rotate(-45deg)}

  .mobile-menu{display:flex;flex-direction:column;position:fixed;top:0;right:0;bottom:0;left:0;background:var(--bg);z-index:200;padding:120px 40px 40px;transform:translateY(-100%);transition:transform .55s cubic-bezier(.7,0,.3,1);overflow-y:auto}
  ...
  .mobile-menu ul a{display:block;padding:24px 0;font-family:"Cormorant Garamond",serif;font-size:36px;color:var(--ink);font-weight:400;letter-spacing:-.005em;transform:translateY(120%);transition:transform .6s cubic-bezier(.7,0,.3,1)}
  ...
  .mobile-cta{display:block;margin-top:40px;padding:18px;text-align:center;background:var(--ink);color:var(--bg);font-size:12px;font-weight:400;letter-spacing:.24em;text-transform:uppercase}
  ...
  .hero h1{font-family:"Cormorant Garamond",serif;font-size:clamp(64px,11vw,180px);font-weight:400;line-height:.92;letter-spacing:-.015em;color:var(--ink);margin-bottom:0}
  ...
  .hero-bottom{display:grid;grid-template-columns:1.5fr 1fr;gap:80px;align-items:end;padding-top:32px;border-top:1px solid var(--line)}
  ...
  .btn-luxe{display:inline-flex;align-items:center;justify-content:space-between;gap:40px;padding:18px 0;font-size:12px;color:var(--ink);letter-spacing:.24em;text-transform:uppercase;font-weight:400;border-top:1px solid var(--ink);border-bottom:1px solid var(--ink);transition:padding .5s cubic-bezier(.7,0,.3,1)}
  ...
  .svc-price{font-family:"Cormorant Garamond",serif;font-size:32px;font-weight:400;color:var(--ink);font-variant-numeric:tabular-nums;white-space:nowrap;text-align:right}
  ...
  .about{padding:140px 0;position:relative;background:var(--bg-2)}
  .about-mosaic{display:grid;grid-template-columns:1fr 1fr;gap:80px;align-items:center;max-width:1280px;margin:0 auto;padding:0 40px}
  .about-photos{position:relative;width:100%;aspect-ratio:4/5;max-height:640px;border-radius:2px;overflow:hidden}
  ...
  .about-text h2{font-family:"Cormorant Garamond",serif;font-size:clamp(40px,5.5vw,72px);font-weight:400;line-height:1.04;letter-spacing:-.015em;margin:24px 0 32px}
  ...
  .about-sig{margin-top:40px;padding-top:32px;border-top:1px solid var(--line-2);display:flex;align-items:center;gap:20px}
  ...
  /* ─── GALLERY · bento ─── */
  .gallery{max-width:1280px;margin:0 auto;padding:0 40px;display:grid;grid-template-columns:repeat(6,1fr);grid-auto-rows:140px;gap:20px}
  ...
  .hours-section{background:var(--paper);padding:140px 0}
  .hours-grid{display:grid;grid-template-columns:1fr 1fr;gap:96px;max-width:1080px;margin:0 auto;padding:0 40px}
  .hours-card h3{font-family:"Cormorant Garamond",serif;font-size:36px;font-weight:400;letter-spacing:-.005em;margin:18px 0 36px}
  ...
  /* ─── REVIEWS ─── */
  .reviews-cta{background:var(--bg);padding:140px 0;text-align:center}
  .reviews-cta-inner{display:flex;flex-direction:column;align-items:center;gap:18px;max-width:680px;margin:0 auto;padding:0 40px}
  .gstars{font-size:32px;color:var(--champagne);letter-spacing:10px;margin-left:10px}
  ...
  .gbtn{margin-top:16px;display:inline-flex;align-items:center;gap:14px;padding:18px 32px;border:1px solid var(--ink);font-size:12px;color:var(--ink);letter-spacing:.24em;text-transform:uppercase;font-weight:400;transition:background .4s,color .4s}
  ...
  .vcard-inner{max-width:1080px;margin:0 auto;padding:0 40px;display:flex;justify-content:space-between;align-items:center;gap:40px;flex-wrap:wrap}
  ...
  .vcard-btn{display:inline-flex;align-items:center;gap:14px;padding:18px 32px;border:1px solid var(--ink);font-size:12px;color:var(--ink);letter-spacing:.24em;text-transform:uppercase;font-weight:400;transition:background .4s,color .4s,padding .5s}
  .vcard-btn:hover{background:var(--ink);color:var(--bg);padding-left:40px;padding-right:40px}

  /* ─── CTA FINAL · bloque tipográfico puro ─── */
  .cta-final{padding:200px 0;text-align:center;background:var(--ink);color:var(--bg);position:relative;overflow:hidden}
  ...
  .cta-final h2{font-family:"Cormorant Garamond",serif;font-size:clamp(64px,11vw,180px);font-weight:400;line-height:.92;letter-spacing:-.02em;margin-bottom:40px;position:relative}
  ...
  .cta-final .actions a{display:inline-flex;flex-direction:column;align-items:center;gap:6px;font-size:11px;color:var(--bg);letter-spacing:.32em;text-transform:uppercase;padding:18px 32px;border:1px solid rgba(255,255,255,.3);transition:border-color .4s,padding .5s}
  ...
  /* ─── FOOTER ─── */
  footer{background:var(--bg);padding:100px 0 32px;border-top:1px solid var(--line)}
  .foot{display:grid;grid-template-columns:1.6fr 1fr 1fr 1fr;gap:64px;padding-bottom:64px;border-bottom:1px solid var(--line);max-width:1280px;margin:0 auto;padding-left:40px;padding-right:40px}
  .foot-brand strong{font-family:"Cormorant Garamond",serif;font-size:36px;font-weight:400;letter-spacing:.02em;color:var(--ink);display:block;margin-bottom:6px}
  ...
  .foot-bot{max-width:1280px;margin:0 auto;padding:32px 40px 0;display:flex;justify-content:space-between;align-items:center;font-size:11px;color:var(--ink-3);letter-spacing:.18em;text-transform:uppercase;flex-wrap:wrap;gap:10px;font-weight:400}
  ...
  .slide-up{opacity:0;transform:translateY(40px);transition:opacity 1.2s cubic-bezier(.7,0,.3,1),transform 1.2s cubic-bezier(.7,0,.3,1)}
  ...
  @media (max-width:980px){
    ...
    .about-mosaic{grid-template-columns:1fr;gap:64px;padding:0 32px}
  ...
  @media (max-width:680px){
    ...
    .hero-triptych{grid-template-columns:1fr;gap:14px;margin:40px 0}
    ...
    .svc-row{grid-template-columns:60px 1fr;gap:18px;padding:32px 0}
  ...
  .nav{--lw-logo-scale:1}
  .brand.brand-has-img .nav-brand-img{display:block;height:calc(36px * var(--lw-logo-scale,1));width:auto;max-width:calc(180px * var(--lw-logo-scale,1));object-fit:contain;margin:0 auto 6px}
  ...
  .luxe-map-directions{display:none;justify-content:center;padding:28px 40px;border-top:1px solid var(--line);background:var(--bg)}
  .luxe-map-directions.is-visible{display:flex}
  .map-dir-btn{display:inline-flex;align-items:center;gap:12px;padding:16px 36px;background:var(--ink);color:var(--bg);font-size:11px;letter-spacing:.18em;text-transform:uppercase;border:1px solid var(--ink);transition:background .3s,color .3s,padding .45s}
